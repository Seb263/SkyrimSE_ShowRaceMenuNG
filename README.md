...
Fixes all issues with stats, attributes, and levels when changing race from the character creation menu. It's standalone, script-free, pluginless, and aims to complete what I started with ShowRaceMenu Alternative back in 2012.

The mod can be downloaded here: [nexusmods.com](https://www.nexusmods.com/skyrimspecialedition/mods/173086)
